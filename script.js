...
switchMode.onclick = function () {
    ...
    if (theme.getAttribute("href") == "css/style-light-theme.css") {
        ...
        imgArrowToTop.src = "https://github.com/imLIVI/site-portfolio/blob/gh-pages/img/icon-up-arrow-dark.png?raw=true";
    } else {
        ...
        imgArrowToTop.src = "https://github.com/imLIVI/site-portfolio/blob/gh-pages/img/icon-up-arrow-light.png?raw=true";
    }
}